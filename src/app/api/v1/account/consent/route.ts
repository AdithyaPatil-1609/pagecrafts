...
//
// The boolean is required, not optional. An absent field would have to mean something, and
// every available meaning — leave it, clear it, assume yes — is a way to get consent wrong.
