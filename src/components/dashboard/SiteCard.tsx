 ...
 *
 * Rendered on the server from a stored UTC time, so it is the same for everyone and does
 * not need the viewer's clock. Precision beyond a day is not useful here — what matters is
 * "recently" versus "a while back".
 */
...
export function SiteCard({ site, now }: { site: ProjectSummary; now: number }) {
